...
def main():
    ...
    pm.AbcExport(j="-frameRange {frameRange} -uvWrite -worldSpace -writeVisibility -dataFormat ogawa {file} -file {path}".format(frameRange=sel_frameRange, file=geo, path=abc_name))
